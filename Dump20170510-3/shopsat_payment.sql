...
CREATE TABLE `payment` (
  ...
  `_amount` varchar(255) DEFAULT NULL,
  `_email` varchar(255) DEFAULT NULL,
  `_text` longtext,
  `shopingCart_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKn6ae5doecpxx6d9e25mkm9h1m` (`shopingCart_id`),
  CONSTRAINT `FKn6ae5doecpxx6d9e25mkm9h1m` FOREIGN KEY (`shopingCart_id`) REFERENCES `shopingCart` (`id`)
